...
def final_block(filters, stage):
    ...
    def layer(img_input):
        ...
        x = Conv2D(filters, kernel_size = (1, 1), padding = 'same', use_bias = False)(img_input)
        x = Activation('softmax', name = 'final_' + stage)(x)
...
===================================================================================================================
Cascaded U-Net
Parameters: 8,444,960
"""
def cascaded_unet(img_rows = 128, img_cols = 128, color_type = 1, num_class = 1):
    ...
    U-Net 1 Encoder
    """
    img_input_1 = Input(shape = (img_rows, img_cols, color_type))
    ...
    U_Net 2 Encoder
    """
    img_input_2 = concatenate([final1, img_input_1], axis = 3)
